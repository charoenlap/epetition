<?php
	...
	define('cache_db','0');
	$base = $_SERVER['DOCUMENT_ROOT'].'/epetition/public_html/';
	if(PRODUCTION){
		// Config DB SERVER
		define('PREFIX', 'b_');
		...
		define('DB_USER','root');
		define('DB_PASS','root');
		define('DB_DB','epetition');
		define('DOCUMENT_ROOT',$_SERVER['DOCUMENT_ROOT'].'/epetition/lib/');
		define('MURL','http://localhost/epetition/public_html/');
	}
  	
  	define('PATH_JSON',$_SERVER['DOCUMENT_ROOT'].'/epetition/json/');
